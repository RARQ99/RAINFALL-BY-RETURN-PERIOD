...
setwd("C:/Users/ANTHONYQUIROZ/Downloads")# Esta es la ruta de la carpeta donde esta Pisco 
...
write.csv(long_lat, "long_lat.csv", quote = F)
...
raster_pp <- raster::brick("PISCO_DIARIO.nc")
...
write.csv(data_long_lat, "data_long_Pd3.csv", quote = F)
